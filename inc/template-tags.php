	...
	function pb_entry_footer() {
		...
		if ( 'post' === get_post_type() ) {
			...
			if ( $categories_list ) {
				...
				printf( '<span class="categories-link">' . esc_html__( '%1$s', 'pb' ) . '</span>', $categories_list ); // WPCS: XSS OK.
			}
			...
			if ( $tags_list ) {
				...
				printf( '<span class="tags-link">' . esc_html__( '%1$s', 'pb' ) . '</span>', $tags_list ); // WPCS: XSS OK.
			}
		}
